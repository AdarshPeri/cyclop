...
export const ReturnQuestionSvg = ({ fill = '#202023' }) => {
  return (
    <div className='relative group/q'>
      ...
      <p
        className={`-right-[85%] clip-pop-right absolute hidden -top-[175px] bg-black px-3 pt-4 pb-8 w-80 group-hover/q:block group-hover:brightness-100 z-50 text-white`}
      >
