          ...
          <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
            <div>
              <label htmlFor='coverLetter'>
                Cover Letter<span className='text-secondary-100'>*</span>
              </label>
              <input type='file' id='coverLetter' className='inputFile' />
              <label
                htmlFor='coverLetter'
              ...
              >
                <span className='text-b-alternate-50/10'>Choose a file</span>
                <svg
                  width='23'
                  height='26'
                  viewBox='0 0 23 26'
            ...
            <div>
              ...
              <input type='file' id='resume' className='inputFile' />
              <label
                htmlFor='resume'
                className='h-20 w-[100%] flex items-center justify-between  border-b-alternate-50/10 border-2 border-dashed rounded-4xl mt-2 px-6'
              >
