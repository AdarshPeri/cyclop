      ...
      <div className='py-48 px-4 md:py-12 md:px-16'>
        ...
        <div className='flex justify-center mt-4'>
          <Link
            ...
            className='flex px-5 md:px-6 py-2 md:py-6 bg-tertiary-50 rounded-4xl items-center justify-between uppercase w-[90%] md:w-[50%] tablet:w-[38%] lg:w-[35%] mb-3 mt-6 text-sm'
          >
