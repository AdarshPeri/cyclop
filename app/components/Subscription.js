...
export const PriceCard = ({ heading, width = '33%', para1, para2 }) => {
  return (
    ...
    >
      <div className='py-4 px-4 tablet:px-8 max-sm:px-8 max-tablet:px-8 max-tablet:py-4 grid grid-cols-1 gap-4 md:max-xl:gap-3 grid-rows-[1fr_4fr_1fr] md:max-tablet:grid-rows-[1fr_2.4fr_1fr] tablet:grid-rows-[1fr_3.6fr_1fr] max-xs:gap-0 lg:gap-0'>
